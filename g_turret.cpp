...
THINK(turret_breach_think)(edict_t *self) -> void {
    ...
    if (delta[0] > self->speed * FRAME_TIME.seconds())
        delta[0] = self->speed * FRAME_TIME.seconds();
    if (delta[0] < -1 * self->speed * FRAME_TIME.seconds())
        delta[0] = -1 * self->speed * FRAME_TIME.seconds();
    if (delta[1] > self->speed * FRAME_TIME.seconds())
        delta[1] = self->speed * FRAME_TIME.seconds();
    if (delta[1] < -1 * self->speed * FRAME_TIME.seconds())
        delta[1] = -1 * self->speed * FRAME_TIME.seconds();
    ...
    self->avelocity = delta * (1.0f / FRAME_TIME.seconds());
    ...
    if (self->owner)
    {
        ...
        self->owner->velocity[0] = dir[0] * 1.0f / FRAME_TIME.seconds();
        self->owner->velocity[1] = dir[1] * 1.0f / FRAME_TIME.seconds();
        ...
        self->owner->velocity[2] = diff * 1.0f / FRAME_TIME.seconds();
