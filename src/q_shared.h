...
static inline uint64_t LongSwap64(uint64_t l)
{
    l = ((l >>  8) & 0x00ff00ff00ff00ff) | ((l <<  8) & 0xff00ff00ff00ff00);
    l = ((l >> 16) & 0x0000ffff0000ffff) | ((l << 16) & 0xffff0000ffff0000);
    l = (l >> 32) | (l << 32);
    return l;
}
...
#define BigLong64(x)    LongSwap64(x)
...
#define LittleLong64(x) LongSwap64(x)
