...
THINK(droptofloor)(edict_t *ent) -> void {
    ...
    {
        ent->mins = vec3_t { -8, -8, -8 } * ent->x.scale;
        ent->maxs = vec3_t { 8, 8, 8 } * ent->x.scale;
    } else
    {
        ent->mins = { -15, -15, -15 };
        ent->maxs = { 15, 15, 15 };
...
{
    if (!level.valid_poi) {
        gi.cprintf(ent, PRINT_HIGH, "Compass data not available for objective.\n");
        return;
    }
...
// RAFAEL
    ...
    */
...
#if 0 // sorry little guy
    {
        ...
        /* pickup_name */  "Disintegrator",
        /* pickup_name_definite */ "the Disintegrator",
        /* quantity */ 1,
        /* ammo */ IT_AMMO_ROUNDS,
        /* chain */ IT_WEAPON_BFG,
        /* flags */ IF_WEAPON | IF_STAY_COOP,
